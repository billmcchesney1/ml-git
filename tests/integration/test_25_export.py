...
class ExportTagAcceptanceTests(unittest.TestCase):
    ...
    def export(self, repotype, entity):
        ...
        self.assertIn(output_messages['INFO_COMMIT_REPO'] % (os.path.join(self.tmp_dir, ML_GIT_DIR, repotype, 'metadata'),
        ...
        self.assertIn(output_messages['INFO_EXPORTING_TAG'] % (tag, store, 's3://mlgit'), check_output(MLGIT_EXPORT % (
