...
class UnlockAcceptanceTests(unittest.TestCase):
    ...
    def test_01_unlock_in_strict_mode(self):
        ...
        self.assertIn(output_messages['ERROR_MUTABILITY_CANNOT_BE_STRICT'], check_output(MLGIT_UNLOCK % ('dataset', 'dataset-ex', 'data/file1')))
        self.assertEqual(2, os.stat(self.file_path).st_nlink)
    ...
    def test_02_unlock_wrong_file(self):
        ...
        self.assertIn(output_messages['ERROR_FILE_NOT_FOUND'] % 'data/file10',
                      check_output(MLGIT_UNLOCK % ('dataset', 'dataset-ex', 'data/file10')))
        self.assertEqual(2, os.stat(self.file_path).st_nlink)
    ...
    def test_03_unlock_flexible_mode(self):
        ...
        self.assertEqual(2, os.stat(self.file_path).st_nlink)
        self.assertIn(output_messages['INFO_FILE_PERMISSIONS_CHANGED'] % 'data/file1',
                      check_output(MLGIT_UNLOCK % ('dataset', 'dataset-ex', 'data/file1')))
